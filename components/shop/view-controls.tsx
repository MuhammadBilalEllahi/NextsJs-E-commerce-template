...
export function ViewControls({
  ...
  // Hide view controls on very small screens since view is automatically single
  ...
  return (
    <div className="flex items-center justify-between gap-4 p-4 bg-white dark:bg-neutral-800 rounded-lg border">
      ...
      <div className="flex items-center justify-center  gap-3 w-full sm:w-auto">
        <span className="hidden lg:block text-sm font-semibold text-neutral-700 dark:text-neutral-300">
          VIEW AS
        </span>
        <div className="flex items-center  gap-1">
          ...
          >
            <img
              ...
              className={` h-8 w-8 ml-3 object-cover transition-all duration-200 ${
                view === "single" ? "opacity-100" : "opacity-40 grayscale"
              }`}
              style={{
          ...
          >
            <img
              ...
              className={`h-8 w-8 object-contain transition-all duration-200 ${
                view === "list" ? "opacity-100" : "opacity-40 grayscale"
              }`}
            />
          </Button>
          <Button
          ...
          >
            <img
              ...
              className={`h-8 ml-2 w-8 object-cover transition-all duration-200 ${
                view === "grid-2" ? "opacity-100" : "opacity-40 grayscale"
              }`}
              style={{
          ...
          >
            <img
              src="/bars/three-lines-vert.svg"
              className={`h-8 w-8 object-contain transition-all duration-200 ${
                view === "grid-3" ? "opacity-100" : "opacity-40 grayscale"
              }`}
            />
          </Button>
          <Button
          ...
          >
            <img
              ...
              className={`h-8 w-8 p-1 object-contain rotate-90 transition-all duration-200 ${
                view === "grid-4" ? "opacity-100" : "opacity-40 grayscale"
              }`}
            />
          </Button>
        </div>
