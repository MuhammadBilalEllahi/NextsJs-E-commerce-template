...
export default function ProductsCreateAdminUI() {
  ...
  const addVariantImages = (
    ...
    setVariants((prev) =>
      prev.map((v, i) =>
        i === variantIndex ? { ...v, images: [...v.images, ...filesArray] } : v
      )
    );
  };
  ...
  return (
    <Card>
      ...
      <CardContent className="grid gap-4">
        ...
        />
        <Textarea
          placeholder="Ingredients & Nutritional Info (optional)"
        ...
        <div className="grid gap-2">
          ...
          <Input
            ...
            max="1000000"
            placeholder={
              variants.length === 0 ? "Stock (required)" : "Stock (optional)"
            }
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded"
              />
              <label htmlFor="isTopSelling" className="text-sm font-medium">
                Product is top selling
              </label>
            </div>
            <div className="flex items-center space-x-2">
              <input
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, isBestSelling: e.target.checked }))
                }
                className="rounded"
              />
              <label htmlFor="isBestSelling" className="text-sm font-medium">
                Product is best selling
              </label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, isSpecial: e.target.checked }))
                }
                className="rounded"
              />
            ...
            <div key={variantIndex} className="grid gap-2 border p-3 rounded">
              <div className="grid sm:grid-cols-2 gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setVariants((prev) =>
                      prev.map((x, j) =>
                        j === variantIndex ? { ...x, sku: e.target.value } : x
                      )
                    )
                  }
                />
                <Input
                  ...
                  onChange={(e) =>
                    setVariants((prev) =>
                      prev.map((x, j) =>
                        j === variantIndex ? { ...x, label: e.target.value } : x
                      )
                    )
                  }
                />
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setVariants((prev) =>
                      prev.map((x, j) =>
                        j === variantIndex ? { ...x, slug: e.target.value } : x
                      )
                    )
                  }
                />
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    addVariantImages(variantIndex, e.target.files)
                  }
                />
                {v.images.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-2">
