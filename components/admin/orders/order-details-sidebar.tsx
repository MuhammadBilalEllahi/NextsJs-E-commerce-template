...
export function OrderDetailsSidebar({ orderId, isOpen, onClose }: OrderDetailsSidebarProps) {
      ...
      >
        {loading ? (
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <Card>
                <CardContent className="p-4 space-y-3">
                  <div>
                    <div className="text-muted-foreground text-sm mb-1">Full name:</div>
                  ...
                  <div>
                    ...
                    <div className="font-medium text-foreground">{order.contact.email}</div>
                  </div>
                  <div>
                    <div className="text-muted-foreground text-sm mb-1">Phone Number:</div>
                    <div className="font-medium text-foreground">{order.contact.phone}</div>
                  </div>
                  <div>
                    <div className="text-muted-foreground text-sm mb-1">Shipping Address:</div>
                    <div className="font-medium text-foreground">
                ...
                {order.history.map((event, index) => (
                  <div key={index} className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-foreground">{event.reason}</div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-foreground">Items {order.items.length}</h3>
                <Button variant="ghost" size="sm" className="hover:bg-muted">
                  <MoreHorizontal className="h-4 w-4 text-muted-foreground" />
                </Button>
              </div>
                  ...
                  <Card key={index}>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium text-sm text-foreground">{item.productTitle}</div>
                          <div className="text-xs text-muted-foreground">{item.variantLabel}</div>
                        </div>
                        <div className="text-right">
                          <div className="font-medium text-foreground">{formatCurrency(item.totalPrice)}</div>
