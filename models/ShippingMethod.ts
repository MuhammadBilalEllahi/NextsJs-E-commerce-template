...
ShippingMethodSchema.index({ "locations.city": 1, "locations.state": 1, "locations.country": 1 });
ShippingMethodSchema.index({ type: 1, isActive: 1 });

export default (mongoose.models[MODELS.SHIPPING_METHOD] as any) || mongoose.model(MODELS.SHIPPING_METHOD, ShippingMethodSchema);
