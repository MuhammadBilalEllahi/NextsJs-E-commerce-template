...
const ReviewSchema = new mongoose.Schema({
  ...
  isEdited: { type: Boolean, default: false }, // Track if review was edited
  editedAt: { type: Date }, // When the review was last edited
...
export default mongoose.models[MODELS.REVIEW] ||
  mongoose.model(MODELS.REVIEW, ReviewSchema);
