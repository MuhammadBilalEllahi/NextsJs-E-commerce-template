...
export const SITE_OG_IMAGE = "/dehli-mirch-og-banner.png";
export const SITE_FAVICON = "/dehli-mirch-og-banner.png"; // TODO: Change to the actual favicon
export const SITE_APPLE_TOUCH_ICON = "/apple-touch-icon.png"; // TODO: Change to the actual apple touch icon

export const DEFAULT_COUNTRY = "Pakistan";
export const DEFAULT_STATE = "Punjab";
...
export const FACEBOOK_PAGE_ID = "dehlimirch";
export const INSTAGRAM_PAGE_ID = "dehlimirch";
