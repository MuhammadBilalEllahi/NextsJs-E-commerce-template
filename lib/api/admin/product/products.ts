...
export const createProduct = async (
  ...
  try {
    ...
    if (productData.isGrocery)
      formData.append("isGrocery", productData.isGrocery.toString());
    if (productData.isSpecial)
      formData.append("isSpecial", productData.isSpecial.toString());
