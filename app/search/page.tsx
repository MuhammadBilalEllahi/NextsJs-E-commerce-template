  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">Find your favorite spices, pickles, and snacks</p>
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { name: "Spices", href: "/category/spices", color: "bg-red-100 text-red-800" },
            { name: "Pickles", href: "/category/pickles", color: "bg-green-100 text-green-800" },
            { name: "Snacks", href: "/category/snacks", color: "bg-yellow-100 text-yellow-800" },
            { name: "Masalas", href: "/category/masalas", color: "bg-blue-100 text-blue-800" },
          ].map((category) => (
            <Link
              key={category.href}
              href={category.href}
