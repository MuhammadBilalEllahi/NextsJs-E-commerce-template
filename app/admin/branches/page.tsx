...
} from "@/lib/api/admin/branches/branches"
...
export default function BranchesAdminPage() {
  ...
  const handleDeleteBranch = async () => {
    ...
    try {
      await removeBranch(deletingBranch._id)
        ...
        <div className="flex-1 flex gap-2">
          <div className="relative flex-1">
            ...
            />
                  ...
                  <Button
          variant="outline"
          onClick={() => setIsActiveFilter(isActiveFilter === undefined ? true : isActiveFilter === true ? false : undefined)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2 text-gray-600">
                          ...
                          <span>{branch.city}, {branch.state} {branch.postalCode}</span>
                        </div>
                        {branch.coordinates && (
                          <div className="text-xs text-gray-500">
                            📍 {branch.coordinates.latitude.toFixed(6)}, {branch.coordinates.longitude.toFixed(6)}
                          </div>
                        )}
                      </div>
