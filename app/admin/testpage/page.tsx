...
export default function PackagingAdminPage() {
  ...
  const [baseImage, setBaseImage] = useState<string>("https://www.dehlimirchmasalajaat.com/public/uploads/all/8fh5fEL5ia9Xse93GmKq2lZy0K1AW7G2bVokpoxt.jpg")
  ...
  const drawBoundingBox = useCallback((ctx: CanvasRenderingContext2D) => {
    if (!file) return
          ...
          <CardContent>
            ...
            <div className="mt-4">
              ...
              <Input
                ...
                accept="image/*"
                className="mt-2"
                onChange={(e) => setCustomBaseImage(e.target.files?.[0] ?? null)}
              />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogoPosition(prev => ({ ...prev, width: Number(e.target.value) }))}
                    min={20}
                    max={CANVAS_WIDTH}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogoPosition(prev => ({ ...prev, height: Number(e.target.value) }))}
                    min={20}
                    max={CANVAS_HEIGHT}
                  />
                </div>
